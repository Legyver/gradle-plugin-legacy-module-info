 ...
 * The transformation fails the build if a Jar does not contain information and no Module information
 * was defined for it. This way we make sure that all Jars are turned into modules.
 */
abstract public class LegacyModuleInfoTransform implements TransformAction<LegacyModuleInfoTransform.Parameter> {
